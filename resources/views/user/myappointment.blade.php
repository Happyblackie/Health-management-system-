...
<head>
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="navbar-collapse " id="navbarSupport">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a style="background-color:greenyellow;" class="nav-link" href="{{ url('myappointment') }}">My Appointments</a>
              </li>
    ...
    <div align="center" class="" style="padding: 70px;">
        <table>
            ...
            <tr style="background-color: black;" align="center">
                ...
                <td> <a onclick="return confirm('are you sure to delete this?')" href="{{ url('cancel_appoint',$appoint->id) }}" class="btn btn-danger">Cancel</a> </td>
